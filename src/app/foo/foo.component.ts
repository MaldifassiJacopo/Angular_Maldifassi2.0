...
export class FooComponent {
  ...
  makeRequest(): void {
    ...
    this.o = this.http.get('https://my-json-server.typicode.com/MaldifassiJacopo/Angular_Maldifassi/football_club');
  ...
  getData = (d : Object) =>
  {
   ...
   makeTypedRequest() : void
   {
     ...
     this.oFoo = this.http.get<Foo[]>('https://my-json-server.typicode.com/MaldifassiJacopo/Angular_Maldifassi/football_club');
